...
fn memory_section<'a>(module: &'a mut elements::Module) -> Option<&'a mut elements::MemorySection> {
...
fn externalize_mem(mut module: elements::Module, adjust_pages: Option<u32>, max_pages: u32) -> elements::Module {
...
fn main() {
    ...
    parity_wasm::elements::serialize_to_file("wasm_with_mem.wasm", module_with_mem)
